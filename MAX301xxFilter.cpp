...
pulseoxymeter_t MAX301xxFilter::update(long redValue, long irValue)
{
...
bool MAX301xxFilter::detectPulse(float sensor_value)
{
...
dcFilter_t MAX301xxFilter::dcRemoval(float x, float prev_w, float alpha)
{
	dcFilter_t filtered;
...
void MAX301xxFilter::lowPassButterworthFilter( float x, butterworthFilter_t * filterResult )
{
...
float MAX301xxFilter::meanDiff(float M, meanDiffFilter_t* filterValues)
{
	float avg = 0;
